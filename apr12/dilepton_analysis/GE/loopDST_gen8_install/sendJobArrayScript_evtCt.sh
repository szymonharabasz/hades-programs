...
currentDir=$(pwd)
day=${1}
submmissionbase=/hera/hades/user/${user}/sub/GE/gen8/dilepton_4to6secd2
...
# nFilesPerJob=200                                                   # number of files to be analyzed by 1 job (default==1)
 nFilesPerJob=50                                                   # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/dilepton_evtCt_4secbins_skipmlt5_minevtsel/${day}
...
par2=${submissiondir}/anaDilepton_evtCt                               # optional par2 : executable
