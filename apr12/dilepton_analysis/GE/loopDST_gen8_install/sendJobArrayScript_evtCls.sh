...
day=${1}
weight=${2}
submmissionbase=/hera/hades/user/${user}/sub/GE/gen8/dilepton_evtCls_nmix
submissiondir=${submmissionbase}/loopDST_gen8_install
 nFilesPerJob=200                                                   # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/dilepton_evtCls_${weight}_minmom_buffsize80_reallynmix_2/${day}
...
par1=/hera/hades/user/harabasz/myhydralibs-newmixer-4.9f/install/defall.sh   # optional par1 : environment script
par2=${submissiondir}/anaDilepton_evtCls                               # optional par2 : executable
...
par7=                                                       # optional par7
resources="-l h_rt=2:0:0,h_vmem=8G"                            # runtime < 10h, mem < 2GB
