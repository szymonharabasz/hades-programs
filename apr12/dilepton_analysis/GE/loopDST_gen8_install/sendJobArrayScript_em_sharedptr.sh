...
currentDir=$(pwd)
day=${1}
submmissionbase=/hera/hades/user/${user}/sub/GE/gen8/dilepton
submissiondir=${submmissionbase}/loopDST_gen8_install
 nFilesPerJob=200                                                   # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/dilepton_em_sharedptr/${day}
...
par2=${submissiondir}/anaDilepton_em_sharedptr                               # optional par2 : executable
