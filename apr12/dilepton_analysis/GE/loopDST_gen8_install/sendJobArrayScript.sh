...
currentDir=$(pwd)
day=${1}
submmissionbase=/hera/hades/user/${user}/sub/GE/gen8/dilepton_anyincomp_nocheckfill_near_nocheckfill_recurexclude
submissiondir=${submmissionbase}/loopDST_gen8_install
 nFilesPerJob=200 # for SIM or EXP extract
# nFilesPerJob=20  # for EXP
# nFilesPerJob=1  # for debug
    jobscript=${submissiondir}/jobArrayScript.sh                        # exec script (full path, call without dot, set it executable!)
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/dilepton_mineff005_emburqmd_skipmlt5_min_maxmom_fm2consist_nearcut_recurgoodlepw6_richQacutg_MLPcutg_incomp_nocheckfill_near_nocheckfill_goodmatrpfw6/${day}/
...
par2=${submissiondir}/anaDilepton                               # optional par2 : executable
...
#par6="109_common_events.txt"                                                       # optional par6
par6="dummy"                                                       # optional par6
par7=                                                       # optional par7
