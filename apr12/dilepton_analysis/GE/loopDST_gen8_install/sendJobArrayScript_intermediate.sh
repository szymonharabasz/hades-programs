...
# nFilesPerJob=1  # for debug
    ...
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/dilepton_macroFromGen7intermediate/${day}/
...
par2=${submissiondir}/anaDilepton_intermediate                               # optional par2 : executable
