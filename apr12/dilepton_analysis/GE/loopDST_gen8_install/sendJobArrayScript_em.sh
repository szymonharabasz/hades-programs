...
day=${1}
weight=${2}
submmissionbase=/hera/hades/user/${user}/sub/GE/gen8/dilepton_em_emburqmd_evtclasmult_mineff002_one_minmom_richQa1
...
# nFilesPerJob=1000                                                   # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/dilepton_em_w${weight}_mineff002_richQa1_emburqmd_fm2_min_maxmom_buffsize80_one_mineffrawtest_3/${day}
...
par2=${submissiondir}/anaDilepton_em                               # optional par2 : executable
...
par7=                                                       # optional par7
resources="-l h_rt=16:0:0,h_vmem=8G"                            # runtime < 10h, mem < 2GB
jobarrayFile="jobarray_${1}_w${weight}.dat"
