...
day=${1}
weight=${2}
submmissionbase=/hera/hades/user/${user}/sub/GE/gen8/dilepton_em_kine_emburqmd_evtclasmult_mineff002_one_minmom_richQa1
...
# nFilesPerJob=1000                                                   # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/dilepton_em_kine_mixall_mymatrice_kinevert_minmom_oa9deg_probdistr_smear_reorganizedcode/${day}
...
par2=${submissiondir}/anaDilepton_em_kine                               # optional par2 : executable
...
par7=                                                       # optional par7
resources="-l h_rt=1:0:0,h_vmem=4G"                            # runtime < 10h, mem < 2GB
