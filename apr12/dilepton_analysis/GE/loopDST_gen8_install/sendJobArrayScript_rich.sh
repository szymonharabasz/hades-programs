...
currentDir=$(pwd)
day=${1}
submmissionbase=/hera/hades/user/${user}/sub/GE/gen8/dilepton_mineff002_fm2consist_emburqmd_minmom_richQaPedowyKineForw6_MLP06
submissiondir=${submmissionbase}/loopDST_gen8_install
 nFilesPerJob=10 # for SIM or EXP extract
...
# nFilesPerJob=1  # for debug
    ...
    outputdir=/hera/hades/user/${user}/apr12/analysis_exp/gen8/rich_test_new_25deg/${day}/
...
par2=${submissiondir}/anaRich                               # optional par2 : executable
